...
**visNetwork** is a R package for network visualization, using **vis.js** javascript library (http://visjs.org/). All the remarks and bug returns are welcome on github : https://github.com/bthieurmel/visNetwork.
