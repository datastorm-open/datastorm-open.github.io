...
New since __visNetwork_0.2.2__ : add [Ionicons](http://ionicons.com/) icons support. For dependencies, you can use **addIonicons()** if needed. Definition process id the same as [fontAwesome](http://fortawesome.github.io/Font-Awesome) icons, except you have to set ``face = 'Ionicons'``.
