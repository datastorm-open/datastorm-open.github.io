...
As seen in introduction, *nodes* must be a data.frame, with at least one column ```id```. You can add properties simply adding variables on data.frame. See **visNodes** for available options. 
...
If you want to set some configuration for all nodes, it's possible in a simpler way, using directly **visNodes** function :
...
## Use complex configuration individually (since __visNetwork_0.2.1__)
