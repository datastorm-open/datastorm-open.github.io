...
```{r}
amHist(x = data_hist, freq = FALSE) %>>% plot()
```
  </div>
  
  <div class="col-xs-12 col-md-6"><h2 class="partdivtitle"> Labels </h2>
```{r}
amHist(x = data_hist, xlab = "xlab", ylab = "ylab") %>>% plot()
```
  </div>
</div>
...
```{r}
amHist(x = data_hist, labels = TRUE) %>>% plot()
```
  </div>
  
  <div class="col-xs-12 col-md-6"><h2 class="partdivtitle"> Set ylim </h2>
```{r}
amHist(x = data_hist, ylim = c(0,.8), freq = FALSE) %>>% plot()
```
  </div>
</div>
