...
amCandlestick(data = data_candleStick2, legend = TRUE)
#or
amCandlestick(data = data_candleStick2) %>>% amOptions(legend = TRUE)
```
```{r, echo = FALSE}
amCandlestick(data = data_candleStick2, legend = TRUE)
```
...
## legendPosition
```{r, echo = TRUE, eval = FALSE}
amCandlestick(data = data_candleStick2, legend = TRUE, legendPosition = "left")
#or
amCandlestick(data = data_candleStick2) %>>% amOptions(legend = TRUE, legendPosition = "left")
```
```{r, echo = FALSE}
amCandlestick(data = data_candleStick2, legend = TRUE, legendPosition = "left")
```
...
## export
```{r, echo = TRUE, eval = FALSE}
amCandlestick(data = data_candleStick2, export = TRUE)
#or
amCandlestick(data = data_candleStick2) %>>% 
...
```{r, echo = TRUE, eval = FALSE}
amCandlestick(data = data_candleStick2, main = "My Candlestick", theme = "patterns")
#or
amCandlestick(data = data_candleStick2) %>>% 
